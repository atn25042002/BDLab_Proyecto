...
atributos={
    ...
    'producto' : ['l1m_producto','ProCod', 'ProNom','ProStc','ProStcMin','ProStcMax','ProStcRsv', 'SecCod', 'MarCod','ProPreUni','UniMedNro','ProEstReg'],
    ...
    'pedido_detalle' : ['g2t_ped_det','PedDetNro','PedCabCod','ProCod','PedDetProFecVenAño','PedDetProFecVenMes','PedDetProFecVenDia','PedDetProCan','PedDetProPreUni','PedDetProPreTot','PedDetObs', 'PedDetEstReg'],
...
campos={
    ...
    'producto' : [['Codigo de Producto',1,11],['Nombre de de Producto',0,60],['Stock del Producto',1,3],['Stock Minimo del Producto',1,3],['Stock Maximo del Producto',1,3],['Stock de Reserva del Producto',1,3],
    ...
    'pedido_detalle' : [['Numero de Pedido Detalle',1,8],['Codigo de Pedido Cabecera',3,10],['Codigo de Producto',3,12],['Fecha de Vencimiento(Año) del Producto',1,4],['Fecha de Vencimiento(Mes) del Producto',1,2]
            ,['Fecha de Vencimiento(Dia) del Producto',1,2],['Producto cantidad de Pedido Detalle',1,5],['Precio Unitario de Producto en Pedido Detalle',2,7],['Precio Total de Producto en Pedido Detalle',2,7],['Observaciones en Pedido Detalle',0,100]],
