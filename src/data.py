...
campos={
    ...
    'pedido_detalle' : [['Numero de Pedido Detalle',1,8],['Codigo de Pedido Cabecera',3,10],['Codigo de Producto',3,12],['Producto cantidad de Pedido Detalle',1,5],['Precio Unitario de Producto en Pedido Detalle',2,5],['Precio Total de Producto en Pedido Detalle',2,5],['Observaciones en Pedido Detalle',0,100]],
    ...
    'ticket_detalle' : [['Numero de Ticket Detalle',1,8,0],['Codigo de Ticket Cabecera',3,10,0],['Codigo de Producto',3,12,4],['Cantidad de Producto en Ticket Detalle',1,4,0],['Precio Unitario en Ticket Detalle',4,5,0],['Precio Total en Ticket Detalle',2,5,0]],
