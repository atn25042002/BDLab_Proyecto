...
campos={
    ...
    'producto' : [['Codigo de Producto',1,12],['Nombre de de Producto',0,60],['Fecha de Vencimiento(Año) del Producto',1,4],['Fecha de Vencimiento(Mes) del Producto',1,2]
            ...
            ['Codigo de Seccion',0,6],['Codigo de Marca',0,6],['Precio Unitario del Producto',2,5],['Numero de Unidad de Medida',1,2]],
    ...
    'pedido_detalle' : [['Numero de Pedido Detalle',1,8],['Codigo de Pedido Cabecera',1,10],['Codigo de Producto',1,12],['Producto cantidad de Pedido Detalle',1,5],['Precio Unitario de Producto en Pedido Detalle',2,5],['Precio Total de Producto en Pedido Detalle',2,5],['Observaciones en Pedido Detalle',0,100]],
    ...
    'ticket_detalle' : [['Numero de Ticket Detalle',1,8],['Codigo de Ticket Cabecera',1,10],['Codigo de Producto',1,12],['Cantidad de Producto en Ticket Detalle',1,4],['Precio Unitario en Ticket Detalle',2,5],['Precio Total en Ticket Detalle',2,5]],
    ...
    'act_inven_detalle' : [['Numero de Actualizacion de Inventario Detalle',1,8],['Codigo de Actualizacion de Inventario Cabecera',1,10],['Codigo de Producto',1,12],['Cantidad de Producto en Actualizacion de Inventario Detalle',1,4],['Detalles/Motivos en Actualizacion de Inventario Detalle',0,60]]
}  
